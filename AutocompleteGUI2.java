...
public class AutocompleteGUI2 extends JFrame {
	...
	public AutocompleteGUI2(String filename, int k) {
	...
	public static void main(String[] args) {
		...
		final String filename = "input20.txt";
		final int k = 5;
		SwingUtilities.invokeLater(new Runnable() {
			
			public void run() {
				new AutocompleteGUI2(filename, k).setVisible(true);
			}
		});
	}
}